...
public class JutsuStorageMenu extends AbstractContainerMenu {
    ...
    public JutsuStorageMenu(int containerId, Inventory playerInventory, RegistryFriendlyByteBuf buf) {
    ...
    public JutsuStorageMenu(int containerId, Inventory playerInventory, ItemStackHandler storageHandler) {
        ...
        // Jutsu storage slots (6 rows of 9)
    ...
    public void removed(Player player) {
        ...
        if (!player.level().isClientSide()) {
            JutsuStorage storage = player.getData(NeoForgeCapabilities.JUTSU_STORAGE);

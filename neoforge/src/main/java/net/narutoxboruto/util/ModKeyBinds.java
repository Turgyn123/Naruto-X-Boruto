...
public class ModKeyBinds {
    ...
    public static final String KEY_DOJUTSU_TOGGLE = "key.narutoxboruto.dojutsu_toggle";
    ...
    public static final KeyMapping CHAKRA_RECHARGE = new KeyMapping(KEY_CHAKRA_RECHARGE, KeyConflictContext.IN_GAME,
    ...
    public static final KeyMapping DOJUTSU_MENU = new KeyMapping(KEY_DOJUTSU_MENU, KeyConflictContext.IN_GAME,
            InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_G, KEY_CATEGORY);

    public static final KeyMapping DOJUTSU_TOGGLE = new KeyMapping(KEY_DOJUTSU_TOGGLE, KeyConflictContext.IN_GAME,

...
import net.narutoxboruto.capabilities.info.WallRunning;
...
public class WallRunningHandlerV2 {
    ...
    public static void onPlayerTick(PlayerTickEvent.Post event) {
        ...
        ChakraControl chakraControl = player.getData(NeoForgeCapabilities.CHAKRA_CONTROL);
        WallRunning wallRunning = player.getData(NeoForgeCapabilities.WALL_RUNNING);
        ClimberComponent climber = player.getData(NeoForgeCapabilities.CLIMBER);
        int chakra = player.getData(NeoForgeCapabilities.CHAKRA).getValue();

...
public class LightningList {
    ...
    public LightningList(String id, String value) { this.id = id; this.value = value; }
    public LightningList(String identifier) { this.id = identifier; this.value = ""; }
    public LightningList() { this("lightning"); }
    ...
    public void syncValue(ServerPlayer serverPlayer) {
        Services.PLATFORM.syncLightningList(serverPlayer, this.value);
    }
}

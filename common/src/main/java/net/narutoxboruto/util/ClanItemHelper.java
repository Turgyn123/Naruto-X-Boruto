...
public class ClanItemHelper {
    ...
    public static boolean isClanItem(ItemStack stack) {
        ...
        return stack.getItem() == ModItems.FUMA_SHURIKEN_ITEM;
    }
    ...
    private static boolean hasFumaShuriken(ServerPlayer player) {
        Item fumaItem = ModItems.FUMA_SHURIKEN_ITEM;
        ...
        // Check jutsu storage
        JutsuStorage storage = Services.PLATFORM.getJutsuStorage(player);
    ...
    public static void giveFumaClanItem(ServerPlayer player) {
        ...
        ItemStack fumaShuriken = new ItemStack(ModItems.FUMA_SHURIKEN_ITEM);

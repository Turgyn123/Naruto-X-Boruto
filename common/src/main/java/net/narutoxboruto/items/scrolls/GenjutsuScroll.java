...
public class GenjutsuScroll extends Item {

    public GenjutsuScroll(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (!pLevel.isClientSide() && pPlayer instanceof ServerPlayer serverPlayer) {
            Genjutsu genjutsu = Services.PLATFORM.getGenjutsu(serverPlayer);
            genjutsu.incrementValue(10, serverPlayer);
